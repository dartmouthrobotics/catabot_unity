...
namespace UnityEngine.Perception.GroundTruth.LabelManagement
{
    ...
    public class Labeling : MonoBehaviour
    {
        ...
        /// <summary>
        /// Whether we need to turn the renderer on and off manually when labeling.
        /// Useful for objects (like HDRP water) that don't provide access to the Material Property Block and require a secondary fake renderer
        /// </summary>
